...
var Avatar = function Avatar(props) {
  ...
  return _react2.default.createElement(
    ...
    null,
    children,
    cover && typeof image === 'string' && _react2.default.createElement('span', { 'aria-label': alt, style: { backgroundImage: 'url(' + image + ')' } }),
    !cover && (typeof image === 'string' ? _react2.default.createElement('img', { alt: alt, src: image }) : image),
    typeof icon === 'string' ? _react2.default.createElement(FontIcon, { value: icon, alt: alt }) : icon,
